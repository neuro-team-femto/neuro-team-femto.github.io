...
Hearing impairments concern up to 86% of brain-stroke survivors, a 38% excess compared to controls of the same age, yet stroke-related hearing is not as well studied as the more obvious symptoms of aphasia or motor loss (Koohi et al. 2017). The objectives of this PhD project is to improve the diagnosis, prognosis and rehabilitation of hearing disorders in stroke survivors. Specifically, the successful applicant will study impairments of speech prosodic perception (e.g. not being to tell apart a question from an affirmation) using a novel data-driven system modeling, reverse correlation. 
